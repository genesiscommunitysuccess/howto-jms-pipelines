...
val sink = jmsSink<MessageSent> {
    ...
    // the following username and password can be encrypted into the system definitions, see https://learn.genesis.global/docs/server/configuring-runtime/system-definitions/#items-defined
