systemDefinition {
    global {
        ...
        item(name = "DbHost", value = "jdbc:h2:file:~/genesis-local-db/jms-pipelines/h2/test;DB_CLOSE_DELAY=-1;NON_KEYWORDS=VALUE,KEY;AUTO_SERVER=TRUE")
        item(name = "DbQuotedIdentifiers", value = true)
        item(name = "DEPLOYED_PRODUCT", value = "jms-pipelines")
    ...
    systems {
        ...
        system(name = "DEV") {
            ...
            item(name = "DbNamespace", value = "JMS_PIPELINES")
